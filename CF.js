// made by DarkBotnet aka mitigations for mesh botnet
...
if (url.hostname.endsWith(blockedDomain)) {
    console.log(`Domain ${blockedDomain} blocked, if this mistake pm to tg DarkBotnet`);
    process.exit(1);
}
...
if (cluster.isMaster) {
    ...
    console.log(`Attack Start /  (Beta Version)`);
